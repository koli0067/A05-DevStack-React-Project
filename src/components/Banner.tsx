    ...
    <div className="container mx-auto">
        <div className="flex justify-between items-center gap-10 flex-col lg:flex-row">
            <div>
                ...
                <p className="pb-8 lg:text-[22px] text-[20px]">Explore frontend, backend, database, and tooling options,<br />
            ...
            <img src={bannerImg} alt="image" className="w-full max-w-[600px] h-auto object-contain" />
        </div>
    </div>
  )
}
